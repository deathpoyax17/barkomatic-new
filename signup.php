                            ...
                            <div class="row register-form container-fluid">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <input type="text" name="address" id="Address" class="form-control" placeholder="Address *" value="" required>
                                    </div>
                                     <div class="form-group">
                                        <input id="phone" type="number" name="phone" class="form-control" placeholder="Contact # *" value=""  required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="submit" class="btnRegister mt-auto" value="Register" id="passenger_submit">
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="tab-pane fade-out active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <form id="shipping-form">
                            ...
                            <div class="row register-form container-fluid">
                                ...
                                <div class="col-md-6 ">
                                     <div class="form-group">
                                        <input type="text" name="name-shipping" id="name-shipping" class="form-control" placeholder="Full Name *" value="" required>
                                    </div>
                                     <div class="form-group">
                                        <input type="text" name="shippingAddress" id="shippingAddress" class="form-control" placeholder="Shipping Line Address *" value="" required>
                                    </div>
                                    <div class="form-group">
