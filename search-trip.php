                                  ...
                                  <!--edited-->
                                            <?php 
                                                ...
                                                while ($row1 = $row_ship_sd->fetch_assoc()) { ?>
                                                          <label>
                                                          <input type="radio" name="srch_ship_sched" class="srch_ship_sched" id="srch_ship_sched" value="<?php echo $row1['ship_name']; ?>">
                                ...
                                <div class="row pt-4">
                                    <div class="col-6 text-dark pl-0 text-left pt-4">
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-control" name="srch_sched_loc_from" id="srch_sched_loc_from"> 
