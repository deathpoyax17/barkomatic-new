...
function search_available_schedule($c) {
    ...
    $output = '
                ...
                <div class="col-sm-4 text-center">
                    <div class="form-group pt-2 text-center">
                        <img src="data:image/jpeg;base64,'.base64_encode($row["ship_logo"]).'" alt="" width="70"><h1>'.$row["vessel"].'</h1>
    ...
    $output = '
                ...
                <div class="col-sm-4 text-center">
                    <div class="form-group pt-2 text-center">
                        <img src="data:image/jpeg;base64,'.base64_encode($row["ship_logo"]).'" alt="" width="70"><h1>'.$row["vessel_name"].'</h1>
                        <input type="hidden" name="srch_sched_ship_nm" value="'.$row["ship_name"].'" class="bg-light border-0" readonly>
                    </div>
                    <br>
                    <br>
