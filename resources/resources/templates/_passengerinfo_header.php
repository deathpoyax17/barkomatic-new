    ...
    <div class="container-modify">
      <div class="itinerary-nav-body">
        <div class="box-group dest-group">
          ...
          <div class="dest-box">
            <div>
              <div class="form-location-code">TAG</div>
        ...
        <div class="box-group mb-tab">
          <div>
            <div class="form-label-title">1</div>
        ...
        <div class="box-group mb-tab">
          <div>
            ...
            <div class="form-label-heading">Return</div>
          </div>
        </div><!---->
        <div class="box-group departure-return d-flex d-lg-none">
          <div class="form-label-title p-1 ">Mon, 6 Feb - Tue, 7 Feb</div>
        </div>
