        ...
        <div class="card">
            <header class="card-header">
                <p class="card-header-title mb-0">
                    <span class="icon"><i class="mdi mdi-account-circle"></i></span> PASSENGERS
                </p>
            </header>
...
<!--                                    <div class="field">-->
<!--                                        <div class="control">-->
<!--                                            <input type="text" name="pl_fname" id="pl_fname" class="input" required>-->
<!--                                        </div>-->
...
<!--                                    <div class="field">-->
<!--                                        <div class="control">-->
<!--                                            <input type="text" name="pl_lname" id="pl_lname" class="input" required>-->
<!--                                        </div>-->
...
<!--                                    <div class="field">-->
<!--                                        <div class="control">-->
<!--                                            <input type="text" name="pl_gender" id="pl_gender" class="input" required>-->
<!--                                        </div>-->
...
<!--                                    <div class="field">-->
<!--                                        <div class="control">-->
<!--                                            <input type="text" name="pl_dob" id="pl_dob" class="input" required>-->
<!--                                        </div>-->
<!--                                        <p class="help">Required. Your Birthday</p>-->
<!--                                    </div>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                        </div>-->
...
<!--                                    <div class="field">-->
<!--                                        <div class="control">-->
<!--                                            <input type="email" name="pl_email" id="pl_email" class="input" required>-->
<!--                                        </div>-->
...
<!--                                <div class="control">-->
<!--                                    <input type="text" name="pl_username" id="pl_username" class="input" required>-->
<!--                                </div>-->
...
<!--                                <div class="control">-->
<!--                                    <input type="password" name="pl_password" id="pl_password" class="input" required>-->
<!--                                </div>-->
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <header class="card-header">
                <p class="card-header-title mb-0">
                    <span class="icon"><i class="mdi mdi-account"></i></span> Passenger
                </p>
            </header>
            <div class="card-content p-0">
                <div class="card has-table border-0">
                    <div class="card-content" id="all_passenger_data">
