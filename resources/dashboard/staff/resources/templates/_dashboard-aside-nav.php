    ...
    <div class="menu is-menu-main">
        ...
        <ul class="menu-list mb-0">
            ...
            <li class="active">
              ...
              <?php if($_GET['page'] == 'add-vessel') { ?>
                    <li class="active">
               <?php } else { ?>
                   <li class="">
               <?php } ?>
                <a style="text-decoration:none;" href="index.php?page=add-vessel" class="dropdown p-1">
                    <span class="icon"><i class="mdi mdi-ship-wheel"></i></span>
                    <span class="menu-item-label">Vessel</span>
                </a>
            </li>
