...
<body class="bg-light">
        ...
        <div class="row">
            <div class="col-md-12 register-right">
                <ul style="padding:1%;margin:1%;font-size:15px;" class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active show" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true">Login</a>
                    </li>
                    <!-- <li class="nav-item">
                ...
                <div class="tab-content container" id="myTabContent">
                    ...
                    <!-- Login as Passenger End -->
                     ...
                     <div class="tab-pane fade-out active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div style="padding-bottom:60px;" class="row register-form col-md-12">
                            <div class="col-md-12">
                            <h3 class="register-heading text-left mt-0 mb-0 display-6 pb-5"><i class="fa fa-lock"></i> Login as</h3>
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                           <input type="button" id="forgot-pass-sh-owner" class="btnRegister text-left float-left mt-3 btn btn-sm bg-transparent text-dark" value="Verify Account?" data-toggle="modal" data-target="#modalShpSt">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="stf_reset_request_form">
                        ...
                        <div class="form-group mt-3">
                            <input type="submit" id="stf_reset_submit" class="btn btn-primary text-center form-control" value="Reset Password">
                        </div>
                        <div class="form-group text-center">
                            <button type="button" class="close form-control" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true"><small class="lead">Done</small></span>
    ...
    <!-- request reset - staff -->
    <div class="modal fade" id="modalShpSt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <div class="alert alert-success lead p-1 font-weight-normal" role="alert" id="alert">
                ...
                <div class="modal-body">
                    <form id="sownr_reset_request_form">
                        <div class="form-group mb-0">
                            <label for="stf_email_forgot" class="col-6-form-label text-left lead font-weight-italic text-center">To verify your account enter your email address associated with your account.</label>
                        ...
                        <div class="form-group mt-3">
                            <input type="submit" name="sownr_reset_submit" id="sownr_reset_submit" class="btn btn-primary text-center form-control" value="Verify Account">
                        </div>
                        <div class="form-group text-center">
                            <button type="button" class="close form-control" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true"><small class="lead">Done</small></span>
